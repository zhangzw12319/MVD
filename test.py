...
from utils.utils import genidx
...
if __name__ == "__main__":
    ...
    if dataset_type == "SYSU":
        ...
        trainset_generator = SYSUDatasetGenerator(data_dir=data_path, ifDebug=False)
        # testing set
    ...
    gallset_generator =\
        TestData(gall_img, gall_label, img_size=(args.img_w, args.img_h), transform=transform_test)
    queryset_generator =\
